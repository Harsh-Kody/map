...
export class RobotComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private mapService: LocalmapService) {}
  ...
  ngAfterViewInit(): void {
    ...
    this.robotSub = this.mapService.getRobotLocation().subscribe((data) => {
      this.robot = data;
    });

    this.pedestrianSub = this.mapService.getPedestrians().subscribe((data) => {
